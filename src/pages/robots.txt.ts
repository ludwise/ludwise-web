 ...
 *
 * Not a security control, and nothing here is written as though it were. Staging is kept private by
 * Cloudflare Access. This only means that a staging page which somehow does reach a crawler is not
 * indexed on top of it. Such a page could arrive through a link in a public issue, or through a
 * proxy that strips the Access cookie. A crawler that ignores this file is not doing anything
 * wrong.
 *
