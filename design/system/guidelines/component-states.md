...
| Button secondary | surface + border.component | surface.interactive-hover | interactive-active | ring | — | as above | as above | — |
...
| TextField | border.component | — | — | border.focus + 2px ring | — | disabled-surface, disabled text | — | danger border, message + `circle-alert`, `aria-invalid` |
| SearchField | border.component | — | — | border.focus + ring | — | — | spinner replaces magnifier, results retained | — |
| Select | border.component | — | — | border.focus + ring | — | disabled-surface | — | danger border + message |
| Checkbox | border.component box | — | — | ring on box | amber fill + check glyph; indeterminate = minus glyph | 55% opacity | — | inherits group error |
| Radio | border.component ring | — | — | ring | amber ring + amber dot | 55% opacity | — | inherits group error |
